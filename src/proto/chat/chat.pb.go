...
/*
	...
	It has these top-level messages:
		...
		NewChatMemberReply
		UnreadChatsCountRequest
		UnreadChatsCountReply
		SetStatusMessage
		EnableSyncRequest
		EnableSyncReply
		UnansweredNotify
...
func (m *UnreadChatsCountRequest) Reset()                    { *m = UnreadChatsCountRequest{} }
func (m *UnreadChatsCountRequest) String() string            { return proto.CompactTextString(m) }
func (*UnreadChatsCountRequest) ProtoMessage()               {}
func (*UnreadChatsCountRequest) Descriptor() ([]byte, []int) { return fileDescriptorChat, []int{26} }

type UnreadChatsCountReply struct {
	// @TODO Remove 'count' in favor of 'total'
	Count uint64 `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"`
	Total uint64 `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`
	// group(shop) id -> chats count
	Groups map[uint64]uint64 `protobuf:"bytes,3,rep,name=groups" json:"groups,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (m *UnreadChatsCountReply) Reset()                    { *m = UnreadChatsCountReply{} }
func (m *UnreadChatsCountReply) String() string            { return proto.CompactTextString(m) }
func (*UnreadChatsCountReply) ProtoMessage()               {}
func (*UnreadChatsCountReply) Descriptor() ([]byte, []int) { return fileDescriptorChat, []int{27} }

func (m *UnreadChatsCountReply) GetGroups() map[uint64]uint64 {
	if m != nil {
		return m.Groups
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UnreadChatsCountRequest)(nil), "chat.UnreadChatsCountRequest")
	proto.RegisterType((*UnreadChatsCountReply)(nil), "chat.UnreadChatsCountReply")
...
type ChatServiceClient interface {
	...
	GetUnreadChatsCount(ctx context.Context, in *UnreadChatsCountRequest, opts ...grpc.CallOption) (*UnreadChatsCountReply, error)
	// append message part
...
func (c *chatServiceClient) GetUnreadChatsCount(ctx context.Context, in *UnreadChatsCountRequest, opts ...grpc.CallOption) (*UnreadChatsCountReply, error) {
	out := new(UnreadChatsCountReply)
	err := grpc.Invoke(ctx, "/chat.ChatService/GetUnreadChatsCount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	// returns total count of unread messages
	GetUnreadChatsCount(context.Context, *UnreadChatsCountRequest) (*UnreadChatsCountReply, error)
	// append message part
...
func _ChatService_GetUnreadChatsCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UnreadChatsCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GetUnreadChatsCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/GetUnreadChatsCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GetUnreadChatsCount(ctx, req.(*UnreadChatsCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ChatService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatService_GetUnreadChatsCount_Handler,
		},
		{
...
func (m *UnreadChatsCountRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnreadChatsCountRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UnreadChatsCountReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnreadChatsCountReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Groups) > 0 {
		for k := range m.Groups {
			...
			i++
			v := m.Groups[k]
			mapSize := 1 + sovChat(uint64(k)) + 1 + sovChat(uint64(v))
			i = encodeVarintChat(dAtA, i, uint64(mapSize))
			dAtA[i] = 0x8
			i++
...
func (m *UnreadChatsCountRequest) Size() (n int) {
	var l int
	_ = l
	if m.UserId != 0 {
		n += 1 + sovChat(uint64(m.UserId))
...
func (m *UnreadChatsCountReply) Size() (n int) {
	var l int
	_ = l
	if m.Count != 0 {
...
func (m *UnreadChatsCountRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnreadChatsCountRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnreadChatsCountRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *UnreadChatsCountReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnreadChatsCountReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnreadChatsCountReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorChat = []byte{
	...
	,
}
