...
const (
	...
	MessageType_FetchThread  MessageType = 254
...
type Message struct {
	...
	Type   MessageType `protobuf:"varint,3,opt,name=type,proto3,enum=bot.MessageType" json:"type,omitempty"`
...
func (*Message) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{6} }
...
func (*Notify) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{7} }

func (m *Notify) GetMessages() []*Message {
	if m != nil {
		return m.Messages
	}
	return nil
...
func (*CreateThreadRequest) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{8} }
...
func (*RawQueryRequest) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{9} }

type RawQueryReply struct {
	Reply string `protobuf:"bytes,1,opt,name=reply,proto3" json:"reply,omitempty"`
	Error string `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (m *RawQueryReply) Reset()                    { *m = RawQueryReply{} }
func (m *RawQueryReply) String() string            { return proto.CompactTextString(m) }
func (*RawQueryReply) ProtoMessage()               {}
func (*RawQueryReply) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{10} }
...
func (*SaveProductResult) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{11} }
...
func init() {
	...
	proto.RegisterType((*Notify)(nil), "bot.Notify")
	proto.RegisterType((*CreateThreadRequest)(nil), "bot.CreateThreadRequest")
	proto.RegisterType((*RawQueryRequest)(nil), "bot.RawQueryRequest")
	proto.RegisterType((*RawQueryReply)(nil), "bot.RawQueryReply")
...
type FetcherServiceClient interface {
	...
	RawQuery(ctx context.Context, in *RawQueryRequest, opts ...grpc.CallOption) (*RawQueryReply, error)
}
...
func (c *fetcherServiceClient) RawQuery(ctx context.Context, in *RawQueryRequest, opts ...grpc.CallOption) (*RawQueryReply, error) {
	out := new(RawQueryReply)
	err := grpc.Invoke(ctx, "/bot.FetcherService/RawQuery", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FetcherServiceServer interface {
	...
	// perform get request for any uri from provided instagram user
	RawQuery(context.Context, *RawQueryRequest) (*RawQueryReply, error)
}
...
func _FetcherService_RawQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RawQueryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FetcherServiceServer).RawQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bot.FetcherService/RawQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FetcherServiceServer).RawQuery(ctx, req.(*RawQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FetcherService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RawQuery",
			Handler:    _FetcherService_RawQuery_Handler,
		},
	},
...
func (m *RawQueryRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.InstagramId != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintBot(dAtA, i, uint64(m.InstagramId))
	}
	if len(m.Uri) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintBot(dAtA, i, uint64(len(m.Uri)))
		i += copy(dAtA[i:], m.Uri)
	}
	return i, nil
}

func (m *RawQueryReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RawQueryReply) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Reply) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBot(dAtA, i, uint64(len(m.Reply)))
...
func (m *RawQueryRequest) Size() (n int) {
	...
	_ = l
	if m.InstagramId != 0 {
		n += 1 + sovBot(uint64(m.InstagramId))
	}
	l = len(m.Uri)
	if l > 0 {
		n += 1 + l + sovBot(uint64(l))
...
func (m *RawQueryReply) Size() (n int) {
	var l int
	_ = l
	l = len(m.Reply)
	if l > 0 {
...
func (m *RawQueryReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RawQueryReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RawQueryReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorBot = []byte{
	...
	,
}
