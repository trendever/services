...
type RetrieveActivitiesRequest struct {
	MentionName string   `protobuf:"bytes,1,opt,name=mention_name,json=mentionName,proto3" json:"mention_name,omitempty"`
...
func (*RetrieveActivitiesRequest) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{0} }

type SendDirectRequest struct {
	ActivityPk string `protobuf:"bytes,1,opt,name=activity_pk,json=activityPk,proto3" json:"activity_pk,omitempty"`
...
func (*SendDirectRequest) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{1} }
...
func (*SendDirectReply) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{3} }
...
func (*Activity) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{4} }
...
func (*DirectMessageNotify) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{5} }
...
func (*CreateThreadRequest) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{6} }
...
func (*CreateThreadReply) Descriptor() ([]byte, []int) { return fileDescriptorBot, []int{7} }
...
func (m *RetrieveActivitiesRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MentionName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBot(dAtA, i, uint64(len(m.MentionName)))
		i += copy(dAtA[i:], m.MentionName)
	}
	if m.AfterId != 0 {
		dAtA[i] = 0x10
		i++
...
func (m *SendDirectRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ActivityPk) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintBot(dAtA, i, uint64(len(m.ActivityPk)))
		i += copy(dAtA[i:], m.ActivityPk)
	}
	if len(m.Text) > 0 {
		dAtA[i] = 0x12
		i++
...
func (m *RetrieveActivitiesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MentionName", wireType)
			}
			...
			m.MentionName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
...
func (m *SendDirectRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActivityPk", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActivityPk = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *DirectMessageNotify) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelatedMedia", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorBot = []byte{
	...
	,
}
